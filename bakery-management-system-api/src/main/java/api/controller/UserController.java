...
import api.models.ListBySuperUserTerm;
...
@RestController
@RequestMapping("/user")
public class UserController extends RestImplementation<UserRepository, User> {
    ...
    private EntityUpdateService<User, UserRepository> reflection;
    ...
    public User create(@RequestBody @Valid User data) {
        ...
        try{
            ...
            BaseLogger.log(UserController.class).error(msg);
    ...
    public User update(@RequestBody @Valid User data, @PathVariable(value = "id") long id) {
        ...
        this.reflection = new EntityUpdateService<>(this.userRepository);
        ...
        try {
            ...
            BaseLogger.log(UserController.class).error(e.getMessage());
